...
export default Buttons;
        ...
        <div className="button-groups">
            <div className= "button1">
                ...
                <br></br>
                <p>A classic card-matching game that tests your memory and sharpens your focus. Earn a 1 to 3-star rating based on how many moves you use. See how fast you can find all eight pairs!</p>
                <a class="waves-effect waves-light btn-large"><i class="material-icons right">beach_access</i>Memory Games</a>
            </div>
            <br></br>
            <br></br>
            <p>This game is a typing game that helps with hand eye coordination as well as typing speed.  Asteroids threaten to impact earth and youre the last line of defense.  When the asteroids appear, type the words that they have written on them to save the earth!</p>
            <div className= "button2">
            <a class="waves-effect waves-light btn-large"><i class="material-icons right">beach_access</i>Typing & Reading Speed</a>
            </div>
            <br></br>
            <br></br>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
            <div  className= "button3">
            <a class="waves-effect waves-light btn-large"><i class="material-icons right">beach_access</i>Critical Thinking</a>
            </div>
            <br></br>
            <br></br>
            <div>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
            <a class="waves-effect waves-light btn-large"><i class="material-icons right">beach_access</i>Easy Entertainment</a>
            </div>
        </div>
        </div> 